...
<h2 class="contentTitle">用户添加</h2>
<form method="post" action="${ctx}/user/add?navTabId=userLiNav&callbackType=closeCurrent" class="required-validate pageForm" onsubmit="return validateCallback(this, navTabAjaxDone);">
